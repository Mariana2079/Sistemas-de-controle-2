...
%% Erro em regime permanente do sistema aumentado compesado
...
erro = limit(s * E, s, 0);
fprintf('Erro em regime permanente do sistema aumentado compesado\n')
disp(erro)
...
R = 1/s;
Y = limit(s * R * E , s, 0);
fprintf('Saida em regime permanente do sistema aumentado\n')
disp(double(Y));
